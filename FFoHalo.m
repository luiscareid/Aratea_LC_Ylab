% FFo. Diciembre 2013
% Calcula el halo alrededor de los contornos seleccionados. Sirve para
% reducir el ruido de fondo en videos donde hay mucha actividad de fondo
% debida a dendritas o axones.
...
function [FFo_dat]=FFoHalo(coord,video)

h=4; %uno o dos pixeles mas que 'h' en la funcion FFo
